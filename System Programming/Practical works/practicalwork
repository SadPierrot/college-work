...
while(key<>'')do begin
 ...
 //Первая ступень (Открыть / Справка / Выйти)
 ...
 {case w1 of
 13:case y of
  0:begin key:='menu_A01';x:=0;y:=0;t1:='';t2:='';end
  38:dec(y);
  40:inc(y);
  end;
 end;}
 ...
 if(c1=#27)then begin key:='main_menu';x:=0;y:=0;t1:='';t2:='';end;
 end;
 ...
 write(t1);write(#201);for i1:=1 to 35 do write(#205);writeln(#187);
 write(t1);write(#186);for i1:=1 to 35 do write(' ');writeln(#186);
 write(t1);write(#186);textcolor(15);write('   Введите название файла          ');textcolor(10);writeln(#186);
 write(t1);write(#186);for i1:=1 to 35 do write(' ');writeln(#186);
 write(t1);write(#186);for i1:=1 to 35 do write(' ');writeln(#186);
 write(t1);write(#186);for i1:=1 to 35 do write(' ');writeln(#186);
 write(t1);write(#186);textcolor(15);write('   ENTER - ВВОД                    ');textcolor(10);writeln(#186);
 ...
 while(key='flights menu')do begin
 clrscr;
 for i1:=1 to 10 do writeln;
 t1:='                                                ';
 t2:='                ';
 ...
 write(t1);write(#186);write(t2);writeln(' '#186);
 write(t1);write(#186'  '#201);for i1:=1 to 11 do write(#205);writeln(#187'  '#186);
 write(t1);write(#186'  '#186);if(y=0)then textcolor(10);write('  Рейсы  ');textcolor(15);writeln(#186'  '#186);
 write(t1);write(#186'  '#200);for i1:=1 to 11 do write(#205);writeln(#188'  '#186);


 write(t1);write(#186'  '#201);for i1:=1 to 11 do write(#205);writeln(#187'  '#186);
 write(t1);write(#186'  '#186);if(y=1)then textcolor(10);write('  Остановки  ');textcolor(15);writeln(#186'  '#186);
 write(t1);write(#186'  '#200);for i1:=1 to 11 do write(#205);writeln(#188'  '#186);


 write(t1);write(#186'  '#201);for i1:=1 to 11 do write(#205);writeln(#187'  '#186);
 write(t1);write(#186'  '#186);if(y=2)then textcolor(10);write('   Остановки рейсов   ');textcolor(15);writeln(#186'  '#186);
 write(t1);write(#186'  '#200);for i1:=1 to 11 do write(#205);writeln(#188'  '#186);
 write(t1);write(#186);write(t2);writeln(' '#186);
 write(t1);write(#200);for i1:=1 to 17 do write(#205);writeln(#188);
 end;
